...
def write_run_config_snapshot(
    ...
    snapshot = {
        ...
        "obst_max_vel_x": params.get("obst_max_vel_x"),
        "obst_max_vel_y": params.get("obst_max_vel_y"),
        "obst_max_vel_z": params.get("obst_max_vel_z"),
        "obst_max_vel_l2": params.get("obst_max_vel_l2"),
        "unknown_inflation_norm": params.get("unknown_inflation_norm"),
